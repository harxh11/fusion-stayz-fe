            ...
            <div className="flex items-center justify-center h-[90vh]">
                <div className="w-[70%] p-10 flex items-center justify-center border-[1px] py-10 bg-white rounded-[10px] text-black">
                    <form className="w-auto pr-10">
                        <h1 className="text-center font-[700] text-[25px]">Welcome Back!</h1>
                        <p className="text-center text-[12px] mb-5 font-[500]">Please Sign In to continue.</p>
                        ...
                        <div className="text-center">
                            <button className=" py-1 px-3 my-4 rounded-[10px] text-white bg-black text-center font-[600] text-[17px]">Submit</button>    
                        </div>
                        ...
                        <div className="pt-3">
                            ...
                            <h1 className="text-center opacity-70 mt-4 cursor-pointer" onClick={() => {router.push('/login')}}>Don't have an account? <span className="font-[700]">Sign Up</span> </h1>
                        </div>
                    </form>
                    <div className="flex items-center justify-center relative border-l-2 pl-5">
                        ...
                        <div className="absolute bg-white bg-opacity-50 px-10 rounded-[20px] text-center py-3">
                            <h1 className="font-[800] my-3 text-[25px]">Welcome Back User!</h1>
